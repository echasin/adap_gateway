...
describe('Controller Tests', function() {
    ...
    describe('Organization Management Detail Controller', function() {
        var $scope, $rootScope;
        var MockEntity, MockPreviousState, MockOrganization, MockOrganizationorganizationmbr, MockCategory, MockSubcategory, MockRecordtype;
        ...
        describe('Root Scope Listening', function() {
            it('Unregisters root scope listener upon scope destruction', function() {
                var eventType = 'adapGatewayApp:organizationUpdate';
