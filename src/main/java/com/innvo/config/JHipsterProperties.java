...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "adap_gateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "adap_gateway API";

        private String description = "adap_gateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "adap_gateway";
