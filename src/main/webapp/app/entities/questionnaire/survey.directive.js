    ...
    angular
        ...
        .directive('choice', function(Questiongroup,Question,Subquestion) {
          ...
          template: '<form name="myForm">'+
                    ...
                    '<tr>'+
                    '<td><label class="radio-inline"><input type="radio" ng-model="questiongroup.id" ng-change="vm.getChoiceAnswer(questiongroup.id,question.id,1)" value="1">1</label></td>'+
                    '<td><label class="radio-inline"><input type="radio" ng-model="questiongroup.id" ng-change="vm.getChoiceAnswer(questiongroup.id,question.id,2)" value="2">2</label></td>'+
                    '<td><label class="radio-inline"><input type="radio" ng-model="questiongroup.id" ng-change="vm.getChoiceAnswer(questiongroup.id,question.id,3)" value="3">3</label></td>'+
                    '<td><label class="radio-inline"><input type="radio" ng-model="questiongroup.id" ng-change="vm.getChoiceAnswer(questiongroup.id,question.id,4)" value="4">4</label></td>'+
                    '<td><label class="radio-inline"><input type="radio" ng-model="questiongroup.id" ng-change="vm.getChoiceAnswer(questiongroup.id,question.id,5)" value="5">5</label></td>'+
                    '</tr>'+
                    '</table>'
         };
        	...
        	return {
                template:    '<textarea ng-model="vm.largeText" ng-change="vm.getLargeText(questiongroup.id,question.id)" cols="50" rows="6"></textarea>'
            };
        });
