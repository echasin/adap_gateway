(function() {
	...
	angular.module('adapGatewayApp').config(stateConfig);
		...
		$stateProvider
											...
											.load([
													{
														...
														name : 'angular-flot',
														files : [
																'app/plugins/flot/jquery.flot.js',
																'app/plugins/flot/jquery.flot.time.js',
																'app/plugins/flot/jquery.flot.tooltip.min.js',
																'app/plugins/flot/jquery.flot.spline.js',
																'app/plugins/flot/jquery.flot.resize.js',
																'app/plugins/flot/jquery.flot.pie.js',
																'app/plugins/flot/curvedLines.js',
																'app/plugins/flot/angular-flot.js', ]
													},
													{
														name : 'angles',
														files : [
																'app/plugins/chartJs/angles.js',
																'app/plugins/chartJs/Chart.min.js' ]
													},
													{
														name : 'angular-peity',
														files : [
																'app/plugins/peity/jquery.peity.min.js',
																'app/plugins/peity/angular-peity.js' ]
													} ])
								}
							}
						})
				...
				.state(
						'dashboard.dashboard2-carb',
						{
							...
							views : {
								'content@' : {
									templateUrl : 'app/entities/dashboard/dashboard2-carb.html',
				...
				.state(
						'dashboard-detail',
						{
							...
							resolve : {
								...
								entity : [ '$stateParams', 'Dashboard',
										function($stateParams, Dashboard) {
